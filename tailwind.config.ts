    ...
    extend: {
      ...
      colors: {
        ...
        dark: {
          ...
          900: "hsl(var(--dark-900) / <alpha-value>)",
        },
        urgency: {
          400: "hsl(var(--urgency-400) / <alpha-value>)",
          500: "hsl(var(--urgency-500) / <alpha-value>)",
          600: "hsl(var(--urgency-600) / <alpha-value>)",
          border: "hsl(var(--urgency-border) / <alpha-value>)",
        },
        success: {
      ...
      animation: {
        ...
        "progress-stripes": "progress-bar-stripes 1s linear infinite",
